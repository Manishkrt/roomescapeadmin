    ...
    <div className={`sidebar ${sidebarClass}`}>
      ...
      <nav className="navigation">
        <ul className="nav-list">
          ...
          <li className="nav-item">
            <div className="Customnav-link" onClick={() => toggleDropdownFucn('availability')}> 
              <i className="fa-solid fa-anchor"></i>
              <span className="Customnav-link-text">Availability</span>
              <span className="submenu-indicator">
                {toggleDropdown.availability ? <i className="fa-solid fa-angle-up"></i> : <i className="fa-solid fa-angle-down"></i>}
              </span>
            </div>
            <ul className={`submenu ${toggleDropdown.availability ? 'open' : ''}`}>
              <li className="nav-item">
